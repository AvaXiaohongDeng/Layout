/*java.awt package(abstract window toolkit)contains many layout manager classes(
  GridLayout/GroupLayout/SpringLayout/GridBagLayout/FlowLayout/CardLayout
  /BoxLayout/BorderLayout) that can be used to place components in a
